 ...
 *
 * Creation date: 29.03.00
 * Last modified: 19.11.04
 * @author: Olaf Neidhardt, modified by Ruth Meyer
 */
public class ProcessesExample extends Model {
	...
	*/
	private desmoj.core.dist.RealDistExponential truckArrivalTime;
	/**
	...
	* See init() method for stream parameters.
	*/
	private desmoj.core.dist.RealDistUniform serviceTime;
	/**
	...
	*/
	...
	public void init() {
		...
		// true                = show in report?
		// false               = show in trace?
		serviceTime= new RealDistUniform(this, "ServiceTimeStream", 3.0, 7.0, true, false);
		...
		// true                     = show in report?
		// false                    = show in trace?
		truckArrivalTime= new RealDistExponential(this, "TruckArrivalTimeStream", 3.0, true, false);
	...
	public static void main(java.lang.String[] args) {
		...
		Experiment exp = new Experiment("ProcessesExampleExperiment");
				// ATTENTION, since the name of the experiment is used in the names of the output files
				// you have to specify a string that's compatible with the filename constraints of your
		...
		exp.tracePeriod(new SimTime(0.0), new SimTime(100));  // set the period of the trace
